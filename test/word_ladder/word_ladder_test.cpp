...
TEST_CASE("[2]: custom small lexicon") {
    ...
    SECTION("[2.1]: ladders are shortest possible, sorted and have correct contents") {
        ...
        SECTION("dog -> hex") {
            ...
            CHECK(ranges::any_of(ladders, testing::contain({"dog", "fog", "foe", "toe", "tox", "hox", "hex"})));
            CHECK(ranges::any_of(ladders, testing::contain({"dog", "fog", "foe", "woe", "wee", "wex", "hex"})));
        }
    ...
    SECTION ("[2.2]: [2.1] but reversed source and destination") {
        ...
        SECTION("hex -> dog") {
            ...
            CHECK(ranges::any_of(ladders, testing::contain({"hex", "hox", "tox", "toe", "foe", "fog", "dog"})));
            CHECK(ranges::any_of(ladders, testing::contain({"hex", "wex", "wee", "woe", "foe", "fog", "dog"})));
        }
